function [r_Pearson p_pearson] = shepardPlot(dissimilarities,disparities,distances,figI,titleString)
...
[r_Pearson p_pearson]=corr(dissimilarities(:),distances(:),'type','Pearson');
