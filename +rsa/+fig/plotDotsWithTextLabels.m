...
if isfield(localOptions, 'dotColours')
	for itemI = 1:nItems
		plot(coords_xy(itemI,1), coords_xy(itemI,2),localOptions.markerStyles{itemI},'MarkerFaceColor',localOptions.dotColours(itemI, :),'MarkerEdgeColor','none','MarkerSize', localOptions.dotSize);
	end%for:itemI
end%if:dotColours
axis off
